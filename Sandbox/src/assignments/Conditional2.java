...
public class Conditional2 {
	...
	public static void main(String[] args) {
		...
		while(f==false) {
			...
			int menu=in.nextInt();
			switch(menu) {
			case 1:m.positiveNegative();f=false;break;
			case 2:m.greatestNumber();f=false;break;
			case 3:m.numbers();f=false;break;
			case 4:m.vowel();f=false;break;
			case 5:f=true;break;
			default:f=false;
			}
